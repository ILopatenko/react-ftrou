...
const Home = () => {
  ...
  return (
    <Page title="Your Feed">
      {state.feed.length > 0 && (
        <>
          <h2 className="text-center mb-4">The latest from you following</h2>
      ...
      {state.feed.length == 0 && (
        <>
          <h2 className="text-center">
            Hello <strong>{appState.user.username.toUpperCase()}</strong>, your feed is empty.
          </h2>
